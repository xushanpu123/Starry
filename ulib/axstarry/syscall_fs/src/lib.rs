...
pub fn fs_syscall(syscall_id: fs_syscall_id::FsSyscallId, args: [usize; 6]) -> SyscallResult {
    match syscall_id {
        ...
        READ => syscall_read(args[0], args[1].into(), args[2]),
        WRITE => syscall_write(args[0], args[1].into(), args[2]),
        GETCWD => syscall_getcwd(args[0].into(), args[1]),
        ...
        GETDENTS64 => syscall_getdents64(args[0], args[1].into(), args[2] as usize),
        MOUNT => syscall_mount(
            args[0].into(),
            args[1].into(),
            args[2].into(),
        ...
        PWRITE64 => syscall_pwrite64(args[0], args[1].into(), args[2], args[3]),
